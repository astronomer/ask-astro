...
def ask_astro_load_github():
    ...
    split_md_docs = split_data(md_dfs=md_docs, rst_dfs=rst_docs, code_dfs=code_samples, issues_dfs=issues_docs)
    ...
    _unimported_data = import_data(md_df=split_md_docs, class_name="Docs", loaded_docs_file_path=_loaded_docs.output)

    (_check_schema >> _alert_schema_branch >> [_slack_schema_alert, md_docs, rst_docs, code_samples, issues_docs])
