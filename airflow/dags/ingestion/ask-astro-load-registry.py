...
def ask_astro_load_registry():
    ...
    registry_cells_docs = task(extract.extract_astro_registry_cell_types, trigger_rule="none_failed", retries=3)()

    registry_dags_docs = task(extract.extract_astro_registry_dags, trigger_rule="none_failed", retries=3)()
