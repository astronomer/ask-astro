...
def ask_astro_load_blogs():
    ...
    def alert_schema_branch(schema_exists: bool) -> str:
        ...
        if schema_exists:
            return ["extract_astro_blogs", "fetch_loaded_docs"]
    ...
    _unimported_md = import_data(blog_docs=split_md_docs, class_name="Docs", loaded_docs_file_path=_loaded_docs.output)

    _check_schema >> _alert_schema_branch >> [_slack_schema_alert, blog_docs]
