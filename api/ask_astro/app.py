...
from ask_astro.config import INTERNAL_SLACK_APP_ID
from ask_astro.rest.controllers import register_routes
from ask_astro.slack.app import app_handler, internal_slack_app, internal_slack_app_handler, slack_app
...
async def endpoint(req: Request):
    ...
    if req.json["api_app_id"] == INTERNAL_SLACK_APP_ID:
        return await internal_slack_app_handler.handle(req)
...
register_controllers(internal_slack_app)
register_routes(api)
